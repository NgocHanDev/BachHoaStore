"""
Django settings for BachHoaStore project.
...
SECRET_KEY = 'django-insecure-9vp3^%1=5#j+23deoch(ey34db7w4*8+sgsh7b&+!+1s7ikqgg'
...
ROOT_URLCONF = 'BachHoaStore.urls'
...
WSGI_APPLICATION = 'BachHoaStore.wsgi.application'
...
VNPAY_RETURN_URL = 'http://127.0.0.1:8000/payment/payment_return'  # URL để nhận kết quả thanh toán
